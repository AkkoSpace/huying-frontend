export default {
  ...
  'tab.title.info': '基本信息',
  'product.info.add': '新增产品',
  'product.info.search': '产品名称',
  ...
  'product.brand.label.brandName': '品牌名称',
  'product.brand.ph.brandName': '请输入品牌名称',
  'product.brand.rules.brandName.required': '品牌名称不能为空',
