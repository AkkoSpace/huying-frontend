export default {
  ...
  'title.info.purchasePrice': '进货单价',
  'title.info.standardPrice': '标准单价',
  'title.category': '产品分类',
  'title.category.add': '新增产品分类',
  'title.category.edit': '编辑产品分类',
  'title.category.view': '查看产品分类',
  ...
  'ph.info.purchasePrice': '请输入进货单价',
  'ph.info.standardPrice': '请输入标准单价',
  ...
  'rules.info.purchasePrice.required': '进货单价不能为空',
  'rules.info.standardPrice.required': '标准单价不能为空',
